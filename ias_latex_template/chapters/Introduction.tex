...
\item Which standards and guidelines apply at the \ac{IAS}?
\item What is to be considered in general when writing student theses at the \ac{IAS}?
\end{itemize}

Read the guidelines for the preparation of student theses at \ac{IAS}! The chapters used in this template are for inspiration only. Each thesis is different and the chapter headings and their order should be adapted accordingly.

...
In the following some examples for the conversion in \LaTeX{} are listed. For formal requirements, please have a look at the guidelines for the preparation of student theses at the \ac{IAS}.
...
Tables are set in a \texttt{table} environment, as shown in \autoref{tab:animalPrices}.
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.5\textwidth]{images/unistuttgart_logo_deutsch_cmyk.eps}
...
We recommend resetting the acronym package after the abstract with \texttt{\textbackslash acresetiall}, so they will be reintroduced in the introduction chapter.
